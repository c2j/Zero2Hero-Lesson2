...
import "../contracts/AIGCToken.sol";

contract MyTokenTest is AIGCToken {
    ...
    function testTokenInitialValues() public {
        Assert.equal(name(), "AIGCToken", "token name did not match");
        Assert.equal(symbol(), "AIGC", "token symbol did not match");
